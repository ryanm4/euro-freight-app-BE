...
CREATE TABLE
    `freight_tracking_app`.`hbl_hawb_tbl` (
        ...
        `total_freight_cost` DECIMAL(10, 3) NULL,
        `created_by` VARCHAR(45) NULL,
        `created_on` DATETIME NULL,
        `updated_by` VARCHAR(45) NULL,
        `updated_on` DATETIME NULL,
...
CREATE TABLE
    `freight_tracking_app`.`shipments` (
        ...
        `status` VARCHAR(45) NULL,
        `voyage_number` VARCHAR(45) NULL AFTER `status`,
        `origin_port` VARCHAR(45) NULL,
        `discharge_port` VARCHAR(45) NULL,
        `final_place_of_delivery` VARCHAR(45) NULL,
        `etd_colombo` VARCHAR(45) NULL,
        `eta_discharge_port` VARCHAR(45),
        `eta_final_delivery_place` VARCHAR(45) NULL,
        `flight_number` VARCHAR(45) NULL,
        `origin` VARCHAR(45) NULL,
        `destination` VARCHAR(45) NULL,
        `etd_origin` VARCHAR(45) NULL,
        `eta_destination` VARCHAR(45) NULL,
        `mbl_mawb_no` VARCHAR(45) NULL,
        `airline_shipping_line` VARCHAR(45) NULL,
